    ...
    <section className="sponsor-spotlight" aria-labelledby="spotlight-title">
      <div className="spotlight-inner">
        <div className="spotlight-header">
          ...
          <Link href="/sponsors" className="spotlight-learn-link">
            Sponsor prospectus ↗
          </Link>
        </div>
        ...
        <div className="spotlight-content">
          <div className="spotlight-main">
            ...
            <div className="spotlight-actions">
              <Link href={s.actionUrl} className="button primary spotlight-btn">
                {s.actionLabel}
              </Link>
              <Link href="/engine" className="button secondary">
